...
A **graph-grounded, hallucination-resistant RAG system** for banking and finance compliance/regulatory documents. The end product is a Claude-like chatbot UI that answers compliance questions with citations, grounded in a knowledge graph + vector hybrid retrieval pipeline.
